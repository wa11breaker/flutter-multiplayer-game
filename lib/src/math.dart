...
double adj(double radians, double magnitude) => cos(radians) * magnitude;

double opp(double radians, double magnitude) => sin(radians) * magnitude;

T clam<T extends num>(T value, T min, T max) => value < min
    ? min
    : value > max
        ? max
        : value;
